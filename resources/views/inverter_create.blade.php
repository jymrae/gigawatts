...
<head>
    ...
    <title>New Inverter</title>
</head>

<body>
    @include("layouts/navbar-admin")
    @include("layouts/errors")
    <div style="width: 500px; margin: 0 auto; "><form action="/admin/inverter" method="POST" enctype="multipart/form-data">
    <h1 style="margin-right: 100px;">New Inverter</h1>
